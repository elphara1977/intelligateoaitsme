...
public class SecurityProviderSample {
    ...
    public static void main(String[] args) {
        ...
        try {
            String password = "Mb7q-X/AK-GLGA-b9sW";
            slotManager.login("assyslunaHA_part2", password);
            ...
            PrivateKey pkey = (PrivateKey) lk.engineGetKey("aitsmeamenc_cer", password.toCharArray());
